...
Respondent's ability to recognize existing federal labor protections was also
...
1. Cannabis workers who express concern over exposure to occupational hazards 
express support for labor rights.
...
\qquad For Hypothesis 4, we will use a similar procedure, but logistic regresesion
will be replaced by linear regression, as we will use the assigned knowledge of
labor rights score as the outcome. Linear regression models are specified as 
